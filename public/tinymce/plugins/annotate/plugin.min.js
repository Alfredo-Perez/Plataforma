tinymce.PluginManager.add('annotate', function (editor, url) {
    editor.addButton('annotate', { t
        title: 'Insert/edit annotation', image: url + '/img/annotation.png', 
        onclick: showDialog, onpostrender: monitorNodeChange }); 
    editor.addButton('delete-annotation', { title: 'Remove annotation', image: url + '/img/delete-annotation.png', onclick: deleteAnnotation, onpostrender: monitorNodeChange }); 
    ...
    function getAnnotation(elm) { r
        eturn $(elm).closest('.annotation') 
    }
    function toggleTemplates(elemID) { 
        tagSelectedValue = elemID; templateArray = new Array(); templateArrayPointer = -1; var tagTemplates = $('.tag-template[data-tag-template-id="' + elemID + '"]'); 
